...
- Helps to show the area of improvement for the up coming young players. 
...
- Appart from the champship data for overall evaluation, we have evaluate other data such as in home play-by-play, Scoring postions, new players performance and the type of goal the players are good at. That help to from a strong team.
